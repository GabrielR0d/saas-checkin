...
export function SettingsPage() {
  ...
  useEffect(() => {
    ...
    fetch(`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(debouncedAddress)}&format=json&limit=1&countrycodes=pt`, {
      ...
      .catch(() => toast.error('Erro ao pesquisar endereço'))
  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Gira notificações e integrações</p>
      </div>
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 space-y-4">
        ...
        {[
          ...
          { key: 'notifyOnUnknown' as const, label: 'Notificar acesso desconhecido' },
        ].map(({ key, label }) => (
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="https://api.meu-dominio.com"
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 space-y-4">
        ...
        {/* Address search */}
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1.5">Pesquisar por endereço</label>
